...
async function getDadosOntem(start, end) {
    ...
    console.log(dados2)
    dados2 = normalizeData(dados2.data, 50, 50000, nomeVariavelBaseDados);
...
async function getDadosMinutos() {
    ...
    if (x) {
        ...
        dados = normalizeData(dados.data, 50, 50000, nomeVariavelBaseDados);
        ...
        refreshOtherTowers(infosVariaveisByName, nomeTorreAtual, 5, grandeza, nomeVariavelBaseDados, 50, 50000);
...
async function getDadosData(start, end) {
    ...
    if (x) {
        ...
        distime();
        refreshOtherTowersByDate(infosVariaveisByName, nomeTorreAtual, dateStartNorm.toISOString(), dateEndNorm.toISOString(), grandeza, nomeVariavelBaseDados, 50, 50000);
